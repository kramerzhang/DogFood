package fl.display {
	...
	public class ProLoader extends Sprite {
	     ...
	     * Call the <code>load()</code> method to load the asset as a child of the Loader instance. 
		 ...
		 * @private
		 */
		public function loadDoneCallback(d:DisplayObject):Boolean
		{
		...
		/**
	         ...
	         * <a href="../system/LoaderContext.html">LoaderContext</a> class.</p>
	         *
...
myMovieClip.loaderInfo.addEventListener(Event.UNLOAD, closeAllStreams);</pre>
		...
		*/
		...
		/**
		 * mimic uncaughtErrorEvents API. Accessing this API in a player that does not support
		 * this property on Loader will throw an Error. Returns type EventDispatcher instead
		 * of UncaughtErrorEvents to avoid VerifyErrors in other players which would occur
		 * even if API was not called.
		 *
