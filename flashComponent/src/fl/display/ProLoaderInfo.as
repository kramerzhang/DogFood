package fl.display {
	...
	/**
	 * Used by ProLoader instead of LoaderInfo. Mimics the APIs of LoaderInfo. 
	 ...
	 * 
	 * <p>Some APIs in this class, including childSandboxBridge and parentSandboxBridge,
	 * are not supported in all versions of the Flash Player and/or AIR, so take care to only call these
	 * when your published AIR or player version supports them or errors will be thrown at runtime.</p>
	...
	public class ProLoaderInfo extends EventDispatcher{
		 ...
		 * @private
		 */
		public var _lcRequestedContentParentSet:Boolean;
		...
		/**
         * Before the first <code>progress</code> event is dispatched by this ProLoaderInfo object's corresponding ProLoader object,
         * <code>bytesTotal</code> is <code>0</code>. After the first progress event from the ProLoader object, <code>bytesTotal</code> 
		...
		/**
         * @copy flash.display.LoaderInfo#childSandboxBridge
         * 
		 *
		 * @playerversion AIR 1.0
		 * @langversion 3.0
		...
		/**
         * @copy flash.display.LoaderInfo#isURLInaccessible
		 * 
		 *
        ...
        * to retrieve the requested information.
		...
		/**
         * @copy flash.display.LoaderInfo#parentSandboxBridge
		 *
		 * @playerversion AIR 1.0
         * @productversion Flash CS5.5
		 * @langversion 3.0
