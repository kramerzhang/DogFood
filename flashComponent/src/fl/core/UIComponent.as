...
package fl.core {
	...
	public class UIComponent extends Sprite {
		...
		protected var _displayObjInstanceDic:Dictionary;
		...
		public function UIComponent() {
			super();
			_displayObjInstanceDic = new Dictionary(true);
			instanceStyles = {};
			sharedStyles = {};
			invalidHash = {};
		...
		protected function getDisplayObjectInstance(skin:Object):DisplayObject {
			if (skin is Class) { 
				if(_displayObjInstanceDic[skin] == null){
					_displayObjInstanceDic[skin] = new skin();
				}
				return _displayObjInstanceDic[skin] as DisplayObject;
			...
			if (_displayObjInstanceDic[skin] == null){
				...
				_displayObjInstanceDic[skin] = new classDef(); 
			}
			return _displayObjInstanceDic[skin] as DisplayObject;
		}
		/**
